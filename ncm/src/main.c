...
/* stb_ds.h lives in the symta runtime now (the consolidation that
 * folded ncm/ under symta/ncm/ also collapsed three near-identical
 * stb_ds.h copies into one).  The build.sh / build.bat add
 * `-I../runtime` so this short include works. */
